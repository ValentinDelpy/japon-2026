...
export const routes: Routes = [
  ...
  { path: 'admin/login', loadComponent: () => import('./admin/login/login-page').then((m) => m.LoginPage) },
  {
    ...
    children: [
      ...
      { path: 'destinations', data: { entity: 'destinations' }, loadComponent: () => import('./admin/entity/entity-editor-page').then((m) => m.EntityEditorPage) },
      { path: 'transport', data: { entity: 'transport_legs' }, loadComponent: () => import('./admin/entity/entity-editor-page').then((m) => m.EntityEditorPage) },
      { path: 'accommodations', data: { entity: 'accommodations' }, loadComponent: () => import('./admin/entity/entity-editor-page').then((m) => m.EntityEditorPage) },
      { path: 'packing', data: { nested: 'packing' }, loadComponent: () => import('./admin/entity/nested-editor-page').then((m) => m.NestedEditorPage) },
      { path: 'checklist', data: { nested: 'checklist' }, loadComponent: () => import('./admin/entity/nested-editor-page').then((m) => m.NestedEditorPage) },
      { path: 'moodboard', data: { nested: 'moodboard' }, loadComponent: () => import('./admin/entity/nested-editor-page').then((m) => m.NestedEditorPage) },
      { path: 'japan101', data: { nested: 'japan101' }, loadComponent: () => import('./admin/entity/nested-editor-page').then((m) => m.NestedEditorPage) },
      { path: 'logistics', data: { nested: 'logistics' }, loadComponent: () => import('./admin/entity/nested-editor-page').then((m) => m.NestedEditorPage) },
