...
export const routes: Routes = [
  ...
  { path: 'admin/login', loadComponent: () => import('./admin/login/login-page').then((m) => m.LoginPage) },
  {
    ...
    children: [
      ...
      { path: 'restaurants', data: { entity: 'restaurants' }, loadComponent: () => import('./admin/entity/entity-editor-page').then((m) => m.EntityEditorPage) },
      { path: 'souvenirs', data: { entity: 'souvenirs' }, loadComponent: () => import('./admin/entity/entity-editor-page').then((m) => m.EntityEditorPage) },
      { path: 'phrases', data: { entity: 'phrases' }, loadComponent: () => import('./admin/entity/entity-editor-page').then((m) => m.EntityEditorPage) },
      { path: 'culture', data: { entity: 'cultural_events' }, loadComponent: () => import('./admin/entity/entity-editor-page').then((m) => m.EntityEditorPage) },
      { path: 'weather', data: { entity: 'weather_info' }, loadComponent: () => import('./admin/entity/entity-editor-page').then((m) => m.EntityEditorPage) },
      { path: 'surprise', data: { entity: 'surprise_items' }, loadComponent: () => import('./admin/entity/entity-editor-page').then((m) => m.EntityEditorPage) },
      { path: 'photos', loadComponent: () => import('./admin/photos/photos-admin-page').then((m) => m.PhotosAdminPage) },
